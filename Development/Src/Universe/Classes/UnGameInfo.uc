...
static event class<GameInfo> SetGameType(string MapName, string Options, string Portal)
{
	...
	if (Left(MapName, 9) ~= "EnvyEntry" || Left(MapName, 10) ~= "UTFrontEnd" || Left(MapName, 11) ~= "UDKFrontEnd" )
	{
...
event InitGame( string Options, out string ErrorMessage )
{
	...
	{
		bAllowKeyboardAndMouse = ( ParseOption( Options, "AllowKeyboard" ) ~= "1" ) || WorldInfo.IsConsoleBuild( CONSOLE_Mobile );
...
// пропускаем выполнение функции в UTHUD
